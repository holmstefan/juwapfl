...
public class CsvReader {
	...
	public final String commentCode;
	public final boolean skipComments;
	public final boolean TRIM_FIELDS = true;
	...
	public CsvReader(String delimiter) {
		this(delimiter, "", false); //$NON-NLS-1$
	}
	...
	public List<String[]> readFile(String filename) {
		...
		if (in == null) {
			System.err.println("Error opening file '" + filename + "'"); //$NON-NLS-1$ //$NON-NLS-2$
			return result;
		}
