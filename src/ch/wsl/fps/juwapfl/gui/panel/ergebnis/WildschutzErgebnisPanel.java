 ...
 *
 */
public class WildschutzErgebnisPanel extends AbstractErgebnisPanel<WildschutzMainWindow, WildschutzErgebnis> {
	...
	public WildschutzErgebnisPanel(WildschutzMainWindow mainWindow) {
		super(mainWindow);
		...
		this.add(new JLabel("<html><center>" + Messages.getString("Common.TitelZeiten") + "</center></html>", SwingConstants.CENTER), getGBC(1, 0, 4)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		this.add(new JLabel("<html><center>" + Messages.getString("Wildschutz.Aufbau") + "</center></html>", SwingConstants.CENTER), getGBC(col++, row)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		
		JLabel lblTitleUnterhaltZeiten = Utilities.getInfoButtonBlue(Utilities.normalizeTooltipText(Messages.getString("Wildschutz.InfoButtonUnterhaltZeiten"))); //$NON-NLS-1$
		lblTitleUnterhaltZeiten.setText("<html><center>" + Messages.getString("Wildschutz.Unterhalt") + "</center></html>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		lblTitleUnterhaltZeiten.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitleUnterhaltZeiten.setHorizontalTextPosition(SwingConstants.LEFT);
		this.add(lblTitleUnterhaltZeiten, getGBC(col++, row));
		
		this.add(new JLabel("<html><center>" + Messages.getString("Wildschutz.Abbau") + "</center></html>", SwingConstants.CENTER), getGBC(col++, row)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		JLabel lblTitleUnterhaltKosten = Utilities.getInfoButtonBlue(Utilities.normalizeTooltipText(Messages.getString("Wildschutz.InfoButtonUnterhaltKosten"))); //$NON-NLS-1$
		lblTitleUnterhaltKosten.setText("<html><center>" + Messages.getString("Wildschutz.Unterhalt") + "</center></html>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		lblTitleUnterhaltKosten.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitleUnterhaltKosten.setHorizontalTextPosition(SwingConstants.LEFT);
		this.add(lblTitleUnterhaltKosten, getGBC(col++, row));
		...
		this.add(new JLabel(Messages.getString("Wildschutz.FahrtenTransporte") + TWO_SPACES, SwingConstants.RIGHT), getGBC(col++, row)); //$NON-NLS-1$
	...
	@Override
	public void setErgebnis(WildschutzErgebnis ergebnis) {
	...
	public String[][] getErgebnisAsStringArray() {
		...
		strings[1] = new String[]{
				Messages.getString("Wildschutz.FahrtenTransporte"), //$NON-NLS-1$
				txtZeitFahrtenAufbau.getText(),
				txtZeitFahrtenUnterhalt.getText(),
				txtZeitFahrtenAbbau.getText(),
				txtZeitFahrtenGesamt.getText(),
