 ...
 *
 */
public abstract class AbstractZBaumDurchforstungErgebnis extends AbstractErgebnis {
	...
	public abstract double getKostenMotorsaege_proBaum();
	public abstract double getKostenMotorsaege_proHektar();
	public abstract double getKostenMotorsaege_proBestand();
	...
	public void printErgebnis() {
		...
		System.out.print( df.format(getKostenMotorsaege_proBaum()) + TAB);
		System.out.print( df.format(getKostenMotorsaege_proHektar()) + TAB);
		System.out.print( df.format(getKostenMotorsaege_proBestand()) + TAB);
