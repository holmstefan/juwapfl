				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/beschaffung"/></fo:block>
						</fo:table-cell>
						
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/transport"/></fo:block>
						</fo:table-cell>
						
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/pflanzung"/></fo:block>
						</fo:table-cell>
