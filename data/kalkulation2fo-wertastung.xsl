				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="center" number-columns-spanned="3">
							<fo:block>
							<xsl:value-of select="../pdftitles/personalzeiten-wpph"/>
							</fo:block>
						</fo:table-cell>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/pro-baum"/></fo:block>
						</fo:table-cell>
						
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/pro-hektare"/></fo:block>
						</fo:table-cell>
						
						<fo:table-cell text-align="right">
							<fo:block><xsl:value-of select="../pdftitles/bestand"/></fo:block>
						</fo:table-cell>
